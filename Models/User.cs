...
namespace MilitaryEquipmentStore.Models
{
    public class User
    {
        ...
        public static void CreateUser(string fullname, string password, string phone, string email) 
        {
            string hashedPassword = BCrypt.Net.BCrypt.HashPassword(password);
            
            string query = $"insert into users (fullname, hashPassword, phonenumber, email_, role_) values ('{fullname}', '{hashedPassword}', '{phone}', '{email}', 'client');";
